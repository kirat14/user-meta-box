...
class UMBCheckboxFieldTest extends CheckboxFieldCommonTestSetup
{
    ...
    public function get_checkbox_html(): string
    {
        ...
        $rslt = UMBCheckboxFieldTest::minify_html($rslt);
...
";
        ...
        $expected = UMBCheckboxFieldTest::minify_html($expected);
